...
{
    internal class NotificarCompraProducer : INotificarCompraProducer
    {
        readonly ConnectionRabbitMq ConnectionRabbitMq;
        readonly ConnectionFactory ConnectionFactory;

        public NotificarCompraProducer(IConfiguration configuration)
        {
            ...
            using (var connection = ConnectionFactory.CreateConnection())
            {
                using (var channel = connection.CreateModel())
                {
                    ...
                    channel.BasicPublish(
                        ...
                        routingKey: $"NOTIFICAR.{order.GetType().Name}",
